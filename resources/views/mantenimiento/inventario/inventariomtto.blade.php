...
<style>
    ...
    #Tablainventariomantenimiento td.col-justificacion {
    ...
    #Tablainventariomantenimiento td {
        ...
        <div class="tabla-scroll-wrapper">
            ...
            <div class="tabla-scroll-bottom">
                <div class="table-responsive">
                    <table id="Tablainventariomantenimiento" class="table table-hover table-bordered  w-100" style="min-width: 1000px; table-layout: fixed;">
                                        ...
                                        <div class="col-9">
                                            <div class="row">
                                                ...
                                                <div class="col-3 mt-2">
                                                    <div class="form-group">
                                                        <label> Marca *</label>
                                                        <input type="text" class="form-control" id="MARCA_EQUIPO" name="MARCA_EQUIPO" required readonly>
                                                    </div>
                                                </div>
                                                <div class="col-3 mt-2">
                                                    <div class="form-group">
                                                        <label> Modelo *</label>
                                                        <input type="text" class="form-control" id="MODELO_EQUIPO" name="MODELO_EQUIPO" required readonly>
                                                    </div>
                                                </div>
                                                <div class="col-3 mt-2">
                                                    <div class="form-group">
                                                        <label> Serie *</label>
                                                        <input type="text" class="form-control" id="SERIE_EQUIPO" name="SERIE_EQUIPO" required readonly>
                                                    </div>
                                                </div>
                                                <div class="col-3 mt-2">
                                                    <div class="form-group">
                                                        <label>Código de Identificación *</label>
                                                        <input type="text" class="form-control" id="CODIGO_EQUIPO" name="CODIGO_EQUIPO" required readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-2 mt-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="Number" step="any" class="form-control" id="CANTIDAD_EQUIPO" name="CANTIDAD_EQUIPO" required readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-2 mt-2">
                                                    <div class="form-group">
                                                        <label> U.M. *</label>
                                                        <input type="text" step="any" class="form-control" id="UNIDAD_MEDIDA" name="UNIDAD_MEDIDA" required readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-4 mt-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control mydatepicker" placeholder="aaaa-mm-dd" id="FECHA_ADQUISICION" name="FECHA_ADQUISICION" required style="pointer-events:none; background-color:#e9ecef;" tabindex="-1">
                                                            <span class="input-group-text"><i class="bi bi-calendar-event"></i></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-4 mt-2">
                                                    ...
                                                    <select class="form-control" name="PROVEEDOR_ALTA" id="PROVEEDOR_ALTA" required style="pointer-events:none; background-color:#e9ecef;" tabindex="-1">
                                                        <option value="" selected disabled>Seleccione una opción</option>
                                                        <option value="1">Sí</option>
                                                        <option value="2">No</option>
                                                    </select>
                                                ...
                                                <div class="col-8 mt-2">
                                                    ...
                                                    <select class="form-control" name="DETALLAR_ARTICULOS" id="DETALLAR_ARTICULOS" required style="pointer-events:none; background-color:#e9ecef;" tabindex="-1">
                                                        <option value="" selected disabled>Seleccione una opción</option>
                                                        <option value="1">Sí</option>
                                                        <option value="2">No</option>
                                                    </select>
                                                ...
                                                <div class="col-3 mt-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" step="any" class="form-control" id="UNITARIO_EQUIPO" name="UNITARIO_EQUIPO" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-3 mt-2">
                                                    <div class="form-group">
                                                        <label> Precio Total</label>
                                                        <input type="text" class="form-control" id="TOTAL_EQUIPO" name="TOTAL_EQUIPO" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-3 mt-2">
                                                    <div class="form-group">
                                                        <label>Tipo *</label>
                                                        <select class="form-select" id="TIPO_EQUIPO" name="TIPO_EQUIPO" required style="pointer-events:none; background-color:#e9ecef;" tabindex="-1">
                                                ...
                                                <div class="col-3 mt-2">
                                                    ...
                                                    <select class="form-control" id="REQUIERE_ARTICULO" name="REQUIERE_ARTICULO" required style="pointer-events:none; background-color:#e9ecef;" tabindex="-1">
                                                        <option value="" selected disabled>Seleccione una opción</option>
                        ...
                        <div class="tab-pane fade" id="contenido-entrada" role="tabpanel">
                            ...
                            <div class="card-body">
                                <div class="card-body position-relative" id="tabla_activo" style="display: block;">
                                    ...
                                    <table id="Tablaentradainventariomantenimiento" class="table table-hover bg-white table-bordered text-center w-100 TableCustom"></table>
                                </div>
                            </div>
                        </div>
