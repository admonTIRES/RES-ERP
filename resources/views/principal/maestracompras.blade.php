...
<body class="body">
    ...
    <script src="/assets/js_sitio/requisiconmaterial/requisicionmr.js?v=5"></script>
    @endif
    ...
    @if(request()->is('listaproveedores'))
    <script src="/assets/js_sitio/proveedor/listaproveedor.js?v=32"></script>
    ...
    <script src="/assets/js_sitio/requisiciongr/requisiciongr.js?v=12"></script>
    @endif
    ...
    <script src="/assets/js_sitio/requisiciongr/requisiciongrhistorial.js?v=11"></script>
    @endif

    @if(request()->is('listaproveedorescriticos'))
    <script src="/assets/js_sitio/proveedor/listraproveedorcritico.js?v=16"></script>
    <script src="/assets/plugins/form_wizard_steps_bootstrap/form_wizard_script.js"></script>
    @endif
    ...
    <script src="/assets/js_sitio/proveedor/relacionpago.js?v=6"></script>
    @endif
    ...
    <script src="/assets/js_sitio/proveedor/listarep.js?v=1"></script>
    @endif
