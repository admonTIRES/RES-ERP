...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td width="20%" class="text-center">
                <img src="{{ public_path('assets/images/MARCAREGISTRADA.png') }}" class="logo" style="margin-top:0px;">
            </td>
    ...
    <div class="card" id="TEXTO_MANIPULACION" style="display:block !important;">
    ...
    <div class="card" id="LEVANTAMIENTO_CARGA" style="display:block !important;">
    ...
    <div class="card" id="ficha_1_1" style="display:block !important;">
    ...
    <div class="card" id="ficha_1_4" style="display:block !important;">
    ...
    <div class="card" id="ficha_1_3" style="display:block !important;">
    ...
    <div class="card" id="TRANSPORTE_CARGAS" style="display:block !important;">
        <div class="card-header header-res">
            <div class="text-center">
    ...
    <div class="card" id="ficha_1_2" style="display:block !important;">
        <div class="card-header header-verde text-center">
            <b>
    ...
    <div class="card" id="ficha_1_5" style="display:block !important;">
        <div class="card-header header-rojo text-center">
            <b>
                FICHA 1.5.
                Evaluación Rápida para identificar
 ...
 <br>
    ...
    <div class="card" id="EMPUJE_TRACCION" style="display:block !important;">
        <div class="card-header header-res">
            <div class="text-center">
    ...
    <div class="card mt-1" id="ficha_2_1" style="display:block !important;">
        <div class="card-header header-verde text-center">
            <b>
    ...
    <div class="card mt-1" id="ficha_2_3" style="display:block !important;">
        <div class="card-header header-rojo text-center">
            <b>
                FICHA 2.3.
                Evaluación Rápida para identificar
    ...
    <div class="card mt-1" id="ficha_2_2" style="display:block !important;">
        <div class="card-header header-azul text-center">
            <b>
    ...
    <div class="card mt-1" id="ficha_3_1" style="display: block;">
        <div class="card-header header-verde text-center">
            <b>
    ...
    <div class="card mt-1" id="ficha_3_2">
        <div class="card-header header-rojo text-center">
            <b>
                FICHA 3.2.
                Evaluación Rápida para identificar
    ...
    <div class="card mt-1" id="ficha_4_1" style="display: block;">
        <div class="card-header header-verde text-center">
            <b>
    ...
    <div class="card mt-1" id="ficha_4_2" style="display: block;">
        <div class="card-header header-verde text-center">
            <b>
