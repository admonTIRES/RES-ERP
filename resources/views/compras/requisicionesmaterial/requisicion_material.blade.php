                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control mydatepicker" placeholder="aaaa-mm-dd" id="FECHA_SOLICITUD_MR" name="FECHA_SOLICITUD_MR" style="pointer-events:none; background-color:#e9ecef;" required tabindex="-1">
